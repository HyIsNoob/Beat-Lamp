...
public class StageLightRenderer implements BlockEntityRenderer<StageLightBlockEntity> {
	...
	public void render(
		...
		drawCore(poseStack, multiBufferSource, coreRed, coreGreen, coreBlue, 0.32F);
	...
	private static org.joml.Quaternionf alignment(StageLightBlockEntity light) {
		Direction facing = light.getBlockState().getValue(com.beatlamp.block.StageLightBlock.FACING);
