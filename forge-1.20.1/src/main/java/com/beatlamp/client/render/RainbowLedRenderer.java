...
public class RainbowLedRenderer implements BlockEntityRenderer<RainbowLedBlockEntity> {
	...
	public void render(
		...
		BlockPos leadPos = (led.getManualGroup() == null || led.getManualGroup().isEmpty()) ? null : led.getManualGroup().get(0);
		if (com.beatlamp.client.DmxMasterTracker.isBlackoutNear(led.getBlockPos()) || com.beatlamp.client.DmxMasterTracker.isGroupMuted(led.getBlockPos(), leadPos)) {
			brightNorm = 0.0F;
		}
