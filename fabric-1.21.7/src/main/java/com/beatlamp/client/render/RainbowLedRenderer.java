...
public class RainbowLedRenderer implements BlockEntityRenderer<RainbowLedBlockEntity> {
	...
	private static void renderFaces(
		...
		// South (+Z)
		if (drawSouth) {
			vertex(consumer, matrix, -inset, -inset, h, r, g, b, a, 0.0F, 0.0F, light, pose);
			vertex(consumer, matrix, inset, -inset, h, r, g, b, a, 1.0F, 0.0F, light, pose);
			vertex(consumer, matrix, inset, inset, h, r, g, b, a, 1.0F, 1.0F, light, pose);
			vertex(consumer, matrix, -inset, inset, h, r, g, b, a, 0.0F, 1.0F, light, pose);
		}
		...
		// East (+X)
		if (drawEast) {
			vertex(consumer, matrix, h, -inset, inset, r, g, b, a, 0.0F, 0.0F, light, pose);
			vertex(consumer, matrix, h, -inset, -inset, r, g, b, a, 1.0F, 0.0F, light, pose);
			vertex(consumer, matrix, h, inset, -inset, r, g, b, a, 1.0F, 1.0F, light, pose);
			vertex(consumer, matrix, h, inset, inset, r, g, b, a, 0.0F, 1.0F, light, pose);
		}
		...
		// Up (+Y)
		if (drawUp) {
			vertex(consumer, matrix, -inset, h, inset, r, g, b, a, 0.0F, 0.0F, light, pose);
			vertex(consumer, matrix, inset, h, inset, r, g, b, a, 1.0F, 0.0F, light, pose);
			vertex(consumer, matrix, inset, h, -inset, r, g, b, a, 1.0F, 1.0F, light, pose);
			vertex(consumer, matrix, -inset, h, -inset, r, g, b, a, 0.0F, 1.0F, light, pose);
		}
